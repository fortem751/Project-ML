...
This repository contains a solution for deploying a Deep Learning inference service (using (using ResNet18 model) and its graphical interface in separate Docker containers.
This setup uses FastAPI for the backend model serving and Gradio for the simple web interface.
Prerequisites
