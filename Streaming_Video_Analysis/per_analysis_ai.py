...
# ADDED: New CSV for Azure AI Service results
OUTPUT_CSV_AZURE = "az_ai_results.csv"
...
def analyze_sls_results(file_path, title_prefix):
    ...
    """
    # ... (Rest of the analyze_sls_results function remains the same as the final version
    #       provided in the last answer, including the analysis for CPU, Memory, etc.) ...
    ...
    if TIME_COL not in df.columns:
        # Fallback for older data that might still use 'proc_time_s'
...
if __name__ == "__main__":
    ...
    # Analyze Part 2 (VM Self-Hosted YOLO)
    analyze_sls_results(OUTPUT_CSV_VM, "Part 2 VM Work")

    # --- ADDED: Analyze Part 4 (Azure AI Service) ---
    analyze_sls_results(OUTPUT_CSV_AZURE, "Part 4 Azure AI Service")
